...
export default {
  ...
  methods: {
    addCatelogSelect() {
      ...
      this.$http({
        url: this.$http.adornUrl("/product/pmscategorybrandrelation/save"),
        method: "post",
    ...
    getCateRelation() {
      this.$http({
        url: this.$http.adornUrl("/product/pmscategorybrandrelation/catelog/list"),
        method: "get",
    ...
    getCateRelation() {
      this.$http({
        url: this.$http.adornUrl(
          "/product/pmscategorybrandrelation/catelog/list"
        ),
        method: "get",
        params: this.$http.adornParams({
          brandId: this.brandId,
