          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.growthPoint = data.umsMemberLevel.growthPoint||0
                this.dataForm.defaultStatus = data.umsMemberLevel.defaultStatus||0
                this.dataForm.freeFreightPoint = data.umsMemberLevel.freeFreightPoint||0
                this.dataForm.commentGrowthPoint = data.umsMemberLevel.commentGrowthPoint||0
                this.dataForm.priviledgeFreeFreight = data.umsMemberLevel.priviledgeFreeFreight||0
                this.dataForm.priviledgeMemberPrice = data.umsMemberLevel.priviledgeMemberPrice||0
                this.dataForm.priviledgeBirthday = data.umsMemberLevel.priviledgeBirthday||0
